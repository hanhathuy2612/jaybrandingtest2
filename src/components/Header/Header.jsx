      ...
      <div className="Header__right">
        <div className="Header__social-login">
          <div className="Header__social-medias">
            <div className="Header__social-medias-item">
              <img className='Header__social-medias-item-icon' src={facebook} alt='Facebook'/>
              <span className='Header__social-medias-item-text'>Facebook</span>
            </div>
            <div className="Header__social-medias-item">
              <img className='Header__social-medias-item-icon' src={youtube} alt='Youtube'/>
              <span className='Header__social-medias-item-text'>Youtube</span>
            </div>
            <div className="Header__social-medias-item">
              <img className='Header__social-medias-item-icon' src={zalo} alt='Zalo'/>
              <span className='Header__social-medias-item-text'>Zalo</span>
            </div>
          </div>

          <div className="Header__social-login-separator">
          </div>

          <div className="Header__login-language">
            <div className="Header__login-action">
              <img className='Header__login-action-icon' src={loginIcon} alt='login'/>
              <span className='Header__login-action-text'>ĐĂNG NHẬP</span>
            </div>
            <div className="Header__language-container">
              <img className="Header__language-item" src={vi} alt='vn'></img>
              <img className="Header__language-item" src={us} alt='us'></img>
            </div>
          </div>
        </div>
        ...
        <div className="Header__navigation">
          <div className="Header__navbar">
            ...
            <div className='Header__navbar-item'>HỖ TRỢ KỸ THUẬT</div>
          ...
          <div className="Header__hotline">
            <div className="Header__hotline-image-wrapper">
              <img className='Header__hotline-image' src={phone} alt=""/>
            </div>
